...
public partial class FundaMapper : IFundaMapper
{
    private const string ProjectType = "Nieuwbouwproject";
    private const string HouseType = "Woonhuis";

    public Listing MapApiListingToDomain(FundaApiListing apiListing, string fundaId)
    {
    ...
    public void EnrichListingWithSummary(Listing listing, FundaApiListingSummary summary)
    {
        // Publication date
    ...
    public void EnrichListingWithNuxtData(Listing listing, FundaNuxtListingData data)
    {
        // Description
