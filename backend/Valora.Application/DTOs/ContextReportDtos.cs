...
public sealed record ContextReportDto(
    [property: Required] [property: ValidateObject] ResolvedLocationDto Location,
    [property: MaxCollectionSize(50)] [property: ValidateObject] IReadOnlyList<ContextMetricDto> SocialMetrics,
    [property: MaxCollectionSize(50)] [property: ValidateObject] IReadOnlyList<ContextMetricDto> CrimeMetrics,
    [property: MaxCollectionSize(50)] [property: ValidateObject] IReadOnlyList<ContextMetricDto> DemographicsMetrics,
    [property: MaxCollectionSize(50)] [property: ValidateObject] IReadOnlyList<ContextMetricDto> HousingMetrics, // Phase 2
    [property: MaxCollectionSize(50)] [property: ValidateObject] IReadOnlyList<ContextMetricDto> MobilityMetrics, // Phase 2
    [property: MaxCollectionSize(50)] [property: ValidateObject] IReadOnlyList<ContextMetricDto> AmenityMetrics,
    [property: MaxCollectionSize(50)] [property: ValidateObject] IReadOnlyList<ContextMetricDto> EnvironmentMetrics,
    double CompositeScore,
    [property: MaxCollectionSize(20)] IReadOnlyDictionary<string, double> CategoryScores,
    [property: MaxCollectionSize(20)] [property: ValidateObject] IReadOnlyList<SourceAttributionDto> Sources,
