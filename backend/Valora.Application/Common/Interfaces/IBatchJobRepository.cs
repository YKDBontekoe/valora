...
public interface IBatchJobRepository
{
    ...
    Task<Valora.Application.Common.Models.PaginatedList<BatchJob>> GetJobsAsync(int pageIndex, int pageSize, BatchJobStatus? status = null, BatchJobType? type = null, CancellationToken cancellationToken = default);
