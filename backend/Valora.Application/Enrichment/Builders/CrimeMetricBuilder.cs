...
public static class CrimeMetricBuilder
{
    public static List<ContextMetricDto> Build(CrimeStatsDto? crime, List<string> warnings)
    {
        ...
        return
        [
            new("total_crimes", "Total Crimes", crime.TotalCrimesPer1000, "per 1000", totalScore, DataSources.CbsStatLineCrime),
            new("burglary", "Burglary Rate", crime.BurglaryPer1000, "per 1000", burglaryScore, DataSources.CbsStatLineCrime),
            new("violent_crime", "Violent Crime", crime.ViolentCrimePer1000, "per 1000", violentScore, DataSources.CbsStatLineCrime),
            new("theft", "Theft Rate", crime.TheftPer1000, "per 1000", null, DataSources.CbsStatLineCrime),
            new("vandalism", "Vandalism Rate", crime.VandalismPer1000, "per 1000", null, DataSources.CbsStatLineCrime)
        ];
    }
