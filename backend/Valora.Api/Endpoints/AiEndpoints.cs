...
public static class AiEndpoints
{
    ...
    private static string BuildAnalysisPrompt(ContextReportDto report)
    {
        ...
        AppendMetrics(sb, Valora.Application.Enrichment.ContextScoreCalculator.CategoryHousing, report.HousingMetrics);
        AppendMetrics(sb, Valora.Application.Enrichment.ContextScoreCalculator.CategoryMobility, report.MobilityMetrics);
