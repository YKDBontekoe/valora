    ...
    >
      ...
      <td className="px-12 py-10 whitespace-nowrap text-right">
        <div className="flex items-center justify-end gap-6">
            <button
                className="opacity-0 group-hover:opacity-100 transition-all duration-700 translate-x-8 group-hover:translate-x-0 p-3 rounded-2xl bg-primary-50 hover:bg-primary-100"
                onClick={(e) => {
                    e.stopPropagation();
                    openDetails(job.id);
                }}
