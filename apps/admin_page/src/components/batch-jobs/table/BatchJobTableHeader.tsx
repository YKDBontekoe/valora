...
export const BatchJobTableHeader: React.FC<BatchJobTableHeaderProps> = ({ sortBy, toggleSort }) => {
  ...
  return (
    <thead className="bg-brand-50/50 backdrop-blur-md">
      <tr>
        <th
          className="px-12 py-8 text-left text-[11px] font-black text-brand-400 uppercase tracking-[0.3em] border-b border-brand-100 cursor-pointer group hover:bg-brand-100/50 transition-all duration-500 focus:outline-none focus:ring-4 focus:ring-primary-500/10 select-none"
        ...
        >
          <div className="flex items-center gap-3 w-full focus:outline-none">
            Definition
