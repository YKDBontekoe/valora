      ...
      <div className="overflow-x-auto custom-scrollbar">
        <table className="min-w-full divide-y divide-brand-100">
          <thead className="bg-brand-50/50 backdrop-blur-md">
            <tr>
              <th
                className="px-12 py-8 text-left text-[11px] font-black text-brand-400 uppercase tracking-ultra-wide cursor-pointer group hover:bg-brand-100/50 transition-all duration-500 select-none focus:outline-none focus:ring-4 focus:ring-primary-500/10 border-b border-brand-100 p-0"
                role="columnheader"
              >
                <button
                  onClick={() => toggleSort('type')}
                  onKeyDown={(e) => handleKeyDown(e, 'type')}
                  className="w-full h-full px-12 py-8 text-left flex items-center gap-3 cursor-pointer focus:outline-none"
              ...
              <th className="px-12 py-8 text-left text-[11px] font-black text-brand-400 uppercase tracking-ultra-wide border-b border-brand-100" role="columnheader">Progress</th>
              <th className="px-12 py-8 text-left text-[11px] font-black text-brand-400 uppercase tracking-ultra-wide border-b border-brand-100" role="columnheader">Context</th>
              <th
                className="px-12 py-8 text-left text-[11px] font-black text-brand-400 uppercase tracking-ultra-wide cursor-pointer group hover:bg-brand-100/50 transition-all duration-500 select-none focus:outline-none focus:ring-4 focus:ring-primary-500/10 border-b border-brand-100 p-0"
                role="columnheader"
              >
              ...
              <th className="px-12 py-8 text-right text-[11px] font-black text-brand-400 uppercase tracking-ultra-wide border-b border-brand-100" role="columnheader">Action</th>
            </tr>
          </thead>
          <motion.tbody
            initial="hidden"
                ...
                <td colSpan={7} className="px-12 py-40 text-center">
                  <div className="flex flex-col items-center gap-10 text-error-500">
                    ...
                    <div className="flex flex-col gap-3">
                        <span className="font-black text-4xl tracking-tightest uppercase tracking-ultra-wide">Sync Failure</span>
              ...
              <tr>
                <td colSpan={7} className="px-12 py-60 text-center">
                  <div className="flex flex-col items-center gap-10 text-brand-100">
                    ...
                    <div className="flex flex-col gap-3">
                        <span className="font-black text-3xl uppercase tracking-ultra-wide text-brand-200">Idle Pipeline</span>
