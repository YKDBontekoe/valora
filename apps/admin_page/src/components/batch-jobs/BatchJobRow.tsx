...
import { Activity, Database, AlertCircle, Info, Clock, ChevronRight } from 'lucide-react';
...
const BatchJobRow = React.forwardRef<HTMLTableRowElement, BatchJobRowProps>(({ job, openDetails }, ref) => {
...
BatchJobRow.displayName = 'BatchJobRow';

export default BatchJobRow;
