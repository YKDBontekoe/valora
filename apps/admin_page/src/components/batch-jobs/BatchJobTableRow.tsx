...
import { Activity, Database, Info, AlertCircle, Clock, ChevronRight } from 'lucide-react';
...
export const BatchJobTableRow = forwardRef<HTMLTableRowElement, BatchJobTableRowProps>(
  ({ job, openDetails }, ref) => {
