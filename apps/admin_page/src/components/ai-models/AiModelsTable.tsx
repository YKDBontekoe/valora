    ...
    >
      <div className="px-10 py-8 border-b border-brand-100 bg-brand-50/30 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 bg-success-50 px-4 py-2 rounded-full border border-success-100/50">
          ...
          <span className="text-[10px] font-black text-success-700 uppercase tracking-widest">OpenRouter Mode</span>
        </div>
      </div>
        ...
        <table className="min-w-full divide-y divide-brand-100">
          <thead>
            <tr className="bg-brand-50/10">
              ...
              <th className="px-10 py-5 text-left text-[10px] font-black text-brand-400 uppercase tracking-widest">Temperature</th>
              <th className="px-10 py-5 text-left text-[10px] font-black text-brand-400 uppercase tracking-widest">Max Tokens</th>
              ...
              <tr>
                <td colSpan={5} className="px-10 py-32 text-center">
                  <div className="flex flex-col items-center gap-6 text-brand-200">
                    ...
                    <span className="font-black text-xl uppercase tracking-widest">No feature configurations defined</span>
                  </div>
                </td>
              </tr>
            ) : (
              <AnimatePresence mode="popLayout">
                {configs.map((config) => (
                  ...
                  >
                    ...
                    <td className="px-10 py-6 whitespace-nowrap">
                      <span className="text-[11px] font-black text-brand-600 font-mono bg-white border border-brand-100 px-3 py-1.5 rounded-lg shadow-sm">{config.temperature.toFixed(1)}</span>
                    </td>
                    <td className="px-10 py-6 whitespace-nowrap">
                      <span className="text-[11px] font-black text-brand-600 font-mono bg-white border border-brand-100 px-3 py-1.5 rounded-lg shadow-sm">{config.maxTokens}</span>
                    </td>
