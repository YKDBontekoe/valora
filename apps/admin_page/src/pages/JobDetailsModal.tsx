              ...
              <div className="flex items-center gap-5">
                  ...
                  <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-[10px] font-black text-primary-600 bg-primary-50 px-2 py-0.5 rounded-md uppercase tracking-ultra-wide">
                              {jobId}
                          </span>
                      </div>
                  </div>
            ...
            <div className="flex-1 overflow-y-auto p-10 space-y-10 custom-scrollbar">
              {loading || !job ? (
                <div className="flex flex-col items-center justify-center py-20 text-brand-200">
                  ...
                  <span className="font-black text-lg uppercase tracking-ultra-wide">Querying Cluster Assets...</span>
                </div>
              ) : (
                <>
                  {/* Status Grid */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="p-6 rounded-[1.5rem] border border-brand-100 bg-brand-50/30 flex flex-col gap-1">
                          ...
                          <div className="font-black text-brand-900 text-2xl tracking-tightest">{job.target}</div>
                      </div>
