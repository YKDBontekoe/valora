        ...
        {fetchError && (
            ...
            >
                ...
                <div className="flex items-center gap-6 relative z-10">
                    ...
                    <span className="text-xl tracking-tightest">{fetchError}</span>
                    </div>
                </div>
        ...
        <div className={`overflow-x-auto transition-opacity duration-500 ${loading && users.length > 0 ? 'opacity-50' : 'opacity-100'}`}>
          <table className="min-w-full divide-y divide-brand-100">
            <thead className="bg-brand-50/50">
              <tr>
                <th
                    className="px-10 py-6 text-left text-[10px] font-black text-brand-400 uppercase tracking-ultra-wide cursor-pointer group hover:bg-brand-100/50 transition-colors select-none p-0"
                    role="columnheader"
                >
                    <button
                        onClick={() => toggleSort('email')}
                        className="w-full h-full px-10 py-6 text-left flex items-center gap-2 cursor-pointer focus:outline-none"
                        aria-label="Sort by identity"
                ...
                <th className="px-10 py-6 text-left text-[10px] font-black text-brand-400 uppercase tracking-ultra-wide" role="columnheader">Authorized Roles</th>
                <th className="px-10 py-6 text-right text-[10px] font-black text-brand-400 uppercase tracking-ultra-wide" role="columnheader">Management</th>
              </tr>
            </thead>
            <motion.tbody
              initial="hidden"
