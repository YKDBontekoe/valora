            ...
            {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-32 text-center gap-8">
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="font-black text-2xl text-brand-900 uppercase tracking-widest">Query Failure</span>
                ...
                <div className="text-center py-40 flex flex-col items-center gap-8">
                    ...
                    <div>
                        <span className="text-brand-900 font-black text-2xl uppercase tracking-widest">Repository Empty</span>
