...
import 'package:valora_app/services/pdok_service.dart' as _i11;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockPdokService extends _i1.Mock implements _i11.PdokService {
  MockPdokService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<List<_i11.PdokSuggestion>> search(String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #search,
          [query],
        ),
        returnValue: _i5.Future<List<_i11.PdokSuggestion>>.value(
            <_i11.PdokSuggestion>[]),
      ) as _i5.Future<List<_i11.PdokSuggestion>>);
