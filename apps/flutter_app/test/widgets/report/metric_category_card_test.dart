...
void main() {
  testWidgets('MetricCategoryCard builds BarChart for Demographics', (
    tester,
  ) async {
    final metrics = [
  ...
  testWidgets('MetricCategoryCard expansion toggle didUpdateWidget coverage', (
    tester,
  ) async {
  ...
  testWidgets('MetricCategoryCard icon mapping covers various keys', (
    tester,
  ) async {
    final testKeys = [
      'residents',
      ...
      'housing_multifamily',
      'housing_pre2000',
      'mobility_cars_household',
      'mobility_car_density',
      'dist_supermarket',
      'dist_gp',
      'dist_school',
      'dist_daycare',
        ...
        MaterialApp(
          home: Scaffold(
            body: MetricCategoryCard(
              ...
              icon: Icons.person,
              metrics: [
                ContextMetric(key: key, label: 'Label', source: 'S', value: 1),
              ],
              score: 80,
              isExpanded: true,
            ),
