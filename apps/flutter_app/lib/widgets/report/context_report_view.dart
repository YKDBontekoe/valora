      ...
      if (index == currentIndex++) {
        return Consumer<ContextReportProvider>(
          builder: (context, provider, _) => MetricCategoryCard(
            ...
            accentColor: ValoraColors.scoreGood,
      ...
      if (index == currentIndex++) {
        return Consumer<ContextReportProvider>(
          builder: (context, provider, _) => MetricCategoryCard(
            ...
            accentColor: ValoraColors.scoreExcellent,
      ...
      if (index == currentIndex++) {
        return Consumer<ContextReportProvider>(
          builder: (context, provider, _) => MetricCategoryCard(
            ...
            accentColor: ValoraColors.primaryLight,
      ...
      if (index == currentIndex++) {
        return Consumer<ContextReportProvider>(
          builder: (context, provider, _) => MetricCategoryCard(
            ...
            accentColor: ValoraColors.newBadge,
      ...
      if (index == currentIndex++) {
        return Consumer<ContextReportProvider>(
          builder: (context, provider, _) => MetricCategoryCard(
            ...
            accentColor: ValoraColors.scoreAverage,
      ...
      if (index == currentIndex++) {
        return Consumer<ContextReportProvider>(
          builder: (context, provider, _) => MetricCategoryCard(
            ...
            accentColor: ValoraColors.success,
