                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Selector<FavoritesProvider, bool>(
                      selector: (_, provider) => provider.isFavorite(widget.listing.id),
                      builder: (context, isFavorite, _) {
                        return GestureDetector(
                          onTap: () => context.read<FavoritesProvider>().toggleFavorite(widget.listing),
                          child: Container(
                    ...
                    child: widget.listing.imageUrl != null
                        ? Hero(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: widget.listing.imageUrl!,
                              fit: BoxFit.cover,
                              placeholder: (context, url) => const Center(child: Icon(Icons.home)),
                            ),
                          )
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Text('Active', style: TextStyle(color: ValoraColors.success, fontSize: 10)),
                        ),
                      ],
                    ),
                    Text(
                      widget.listing.address,
                      style: ValoraTypography.bodySmall.copyWith(color: isDark ? ValoraColors.neutral400 : ValoraColors.neutral500),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                    const SizedBox(height: 12),
  ...
  Widget _buildFeature(BuildContext context, IconData icon, String label) {
    ...
    return Row(
      children: [
        ...
        const SizedBox(width: 4),
        Text(label, style: ValoraTypography.labelSmall.copyWith(color: isDark ? ValoraColors.neutral400 : ValoraColors.neutral500)),
      ],
    );
  }
}
