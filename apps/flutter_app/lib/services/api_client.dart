...
class ApiClient {
  ...
  T handleResponse<T>(http.Response response, T Function(String body) parser) {
  ...
  Future<dynamic> get(String path, {Map<String, dynamic>? queryParameters, Duration? timeout}) async {
    ...
    try {
      ...
      throw handleException(e, stack, uri);
    }
  }
