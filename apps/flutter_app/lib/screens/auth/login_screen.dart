...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDark ? ValoraColors.backgroundDark : ValoraColors.backgroundLight,
      body: Center(
                ...
                child: Column(
                  ...
                  Text(
                    ...
                    style: ValoraTypography.headlineMedium.copyWith(
                      ...
                      color: isDark ? ValoraColors.onSurfaceDark : ValoraColors.onSurfaceLight,
                    ),
                  ),
                  ...
                  Row(
                    children: [
                      Expanded(child: Divider(color: isDark ? ValoraColors.neutral700 : ValoraColors.neutral200)),
                      Padding(
